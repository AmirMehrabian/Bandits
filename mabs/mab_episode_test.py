...
for index_train in num_train_vec:
    avg_error = []
    avg_rev = []
    avg_opt_act = []
    ...
    final_avg_rev_vec.append(final_avg_rev )
    final_avg_opt_act_vec.append(final_avg_opt_act )
    final_avg_error_vec.append(final_avg_error)
