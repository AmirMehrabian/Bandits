...
plot_info = {'curves': {
    ...
    'final_avg_rev': script.final_avg_rev_vec,
    'final_avg_opt_act': script.final_avg_opt_act_vec,
    'final_avg_error': script.final_avg_error_vec,
    'num_tain_vec': script.num_train_vec,
    'num_iter': script.NUM_ITER,
    },
